    ...
    <div className="bg-[#222] mt-5 rounded-t-3xl py-8">
      <div className="flex flex-col md:flex-row justify-between md:px-32 px-5">
        <div className="w-full md:w-1/4">
          ...
          <p className="mt-4">
            The best fitness destination in Greater Noida, for men and women.
          </p>
        </div>
        <div className="mt-8 md:mt-0 md:ml-8">
          <h1 className="font-medium text-xl text-brightRed">Address</h1>
          <p className="mt-4">
            Knowledge park 2 , Greater Noida , UP, India - 201306
          </p>
        </div>
        <div className="mt-8 md:mt-0 md:ml-8">
        ...
        <div className="mt-8 md:mt-0 md:ml-8">
          ...
          <div className="flex flex-row items-center mt-4">
            ...
            <p className="ml-2">+91-8318033578</p>
          </div>
          <div className="flex flex-row items-center mt-2">
            <AiOutlineMail size={20} color="red" />
            <p className="ml-2">unitedgym@gmail.com</p>
          </div>
        </div>
      </div>
      <div className="mt-8">
